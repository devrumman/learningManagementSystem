          ...
          <div class="row">
              ...
              <div class="col-md-6">
                  <ul class="nav justify-content-end course-options" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="dhanmondi-tab" data-toggle="tab" href="#dhanmondi" role="tab" aria-controls="dhanmondi" aria-selected="false">Dhanmondi Courses</a>
                    </li>
                  </ul>
              </div>
              <!-- Tab Panel End -->
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="allCourses" role="tabpanel" aria-labelledby="allCourses-tab">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="course-item">
                                    <div class="course-item-img">
                                        ...
                                        <a href="{{route('courses.details', $batch->slug)}}">
                                        <img src="{{asset('backend/img/course/' . $batch->course->image)}}" alt="">
                                        </a>
                                        <a href="{{route('courses.details', $batch->slug)}}" class="course-link">+</a>                              
                                    </div>

                                    <div class="course-summary box">
                                        
                                        <div class="course-summary-inner">
                                            <h4>{{$batch->course->bangla_titel}}</h4>
                                            <ul class="course-meta">
                                                ...
                                                <li>
                                                    ...
                                                    <span class="blue-highlight">{{$batch->sit_number}}</span>
                                                </li>
                                            </ul>

                                            <a href="{{route('courses.details', $batch->slug)}}" class="btn btn-entroll">Enroll Now</a>
                                        </div>
                                    </div>
                    ...
                    <!-- Mirpur Courses Start -->
                    <h2 class="sec-title">Dhanmondi Branch Offered Courses</h2>
                    <!-- Mirpur Courses End -->
                    <div class="row">

                    @foreach ($batches as $batch)
                        @if ($batch->branch_id == 3)
                            <!-- Course Start -->
                            <div class="col-md-4">
                                <!-- Course List Start -->
                                <div class="course-item">
                ...
                <div class="tab-pane fade" id="dhanmondi" role="tabpanel" aria-labelledby="dhanmondi-tab">
                    <!-- Dhanmondi Courses Start -->
                    <h2 class="sec-title">Dhanmondi Branch Offered Courses</h2>
                    <!-- Dhanmondi Courses End -->
                    <div class="row">
                        <!-- Course Start -->
                        @foreach ($batches as $batch)
                            @if ($batch->branch_id == 3)
