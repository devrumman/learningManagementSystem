...
<html lang="en">
  <head>
    ...
    <title>Web Application | Landing Page</title>
    ...
    <link rel="stylesheet" href="{{asset('frontend/assets/css/jquery.fancybox.css')}}">
    <!-- Font Awesome -->
          ...
          <div class="col-md-12">
            <nav class="navbar navbar-expand-lg navbar-light">
              ...
              <a class="navbar-brand" href="{{route('home')}}">
                <img src="{{asset('frontend/assets/images/logo.png')}}" class="logo">
              </a>
              <!-- Logo End -->
              ...
              <div class="navbar-collapse justify-content-center" id="sidebar">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <a data-scroll="" class="nav-link section-scroll" href="{{route('about')}}">About Us</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link btn-header mobile-hidden" href="{{route('getadmission', $batch->slug)}}">Get Admitted</a>
                  </li>
      ...
      <div class="container landing-banner">
        <div class="row">
          ...
          <div class="col-md-5 col-sm-12 col-12">
            <!-- Banner Heading Text -->
            <h1>{{$batch->course->english_titel}}</h1>

            <!-- Banner Course Short Info Text -->
            <div class="ln-course-info">
              <ul>
                <li>কোর্সের মেয়াদ : <span>{{$batch->course->course_duration}}</span></li>
                <li>কোর্স ফী : <span>{{$batch->course->bangla_price}}</span></li>
                <li>ক্লাসের সময় : <span>{{$batch->class_day}} / {{$batch->class_time}}</span></li>
                <li>ক্লাস শুরুর তারিখ : <span>{{$batch->starting_date}}</span></li>
              </ul>
            </div>
            ...
            <div class="ln-banner-btn">
              <ul>
                <li>
                  <a href="{{route('getadmission', $batch->slug)}}" class="btn-banner-one" data-toggle="modal" data-target="#admission">ভর্তি হোন</a>
                </li>
                <li>
          ...
          <div class="col-md-7 col-sm-12 col-12">
            <img src="{{asset('frontend/assets/images/course-details/banner-bg.png')}}" class="img-fluid">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="ln-tab-panel" id="sticky">
              <!-- Tab Logo -->
              <img src="{{asset('frontend/assets/images/course-details/logo.png')}}" class="tab-logo">
              ...
              <!-- Tab Button -->
              <a href="{{route('getadmission', $batch->slug)}}" class="tab-btn btn-block" data-toggle="modal" data-target="#admission">ভর্তি হোন</a>
              <!-- Tab Options End -->
            </div>
          </div>
          ...
          <div class="col-md-8 offset-md-1 ln-course-details" >
            <!-- Section Title -->
            <h2><span class="blue-shadow">{{$batch->course->bangla_titel}}</span></h2>

            <!-- Section paragraph -->
            <p>{{$batch->course->curriculam_description}}</p>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="ln-course-details-video">
                  <!-- Video Thumbnail -->
                  <img src="{{asset('frontend/assets/images/course-details/course-details-video.png')}}" class="img-fluid">
                  <!-- Hover Content -->
                  <div class="ln-course-details-video-hover">
                    <a data-fancybox href="{{$batch->course->intro_video}}">
              ...
              <div class="col-md-4 mt-50">
                <div class="ln-course-details-summary">
                  <h2>{{$batch->course->graduate_number}}</h2>
                  <h4>গ্রাডুয়েটস</h4>

                  <h2>{{$batch->course->class_hour}}</h2>
                  <h4>ক্লাস আওয়ার্স</h4>
              ...
              <div class="process-wrapper">
                ...
                <div id="progress-bar-container">
                  ...
                  <ul>
                    <li class="step step01 active">
                      <div class="step-inner">{{$courseCuriculam->one_en}}</div>
                      <p>1 মাস</p>
                    </li>
  
                    <li class="step step02">
                      <div class="step-inner">{{$courseCuriculam->two_en}}</div>
                      <p>2 মাস</p>
                    </li>
  
                    <li class="step step03">
                      <div class="step-inner">{{$courseCuriculam->three_en}}</div>
                      <p>3 মাস</p>
                    </li>
  
                    <li class="step step04">
                      <div class="step-inner">{{$courseCuriculam->four_en}}</div>
                      <p>4 মাস</p>
                    </li>
  
                    <li class="step step05">
                      <div class="step-inner">{{$courseCuriculam->five_en}}</div>
                      <p>5 মাস</p>
                    </li>
                  </ul>
                  <!-- Step Heading End -->
                ...
                <div id="progress-content-section">
                  ...
                  <div class="section-content content01 active">
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-12">
                        <h3>{{$courseCuriculam->one_bn}}</h3>
                        <p>{{$courseCuriculam->one_desc}}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="section-content content02">
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-12">
                        <h3>{{$courseCuriculam->two_bn}}</h3>
                        <p>{{$courseCuriculam->two_desc}}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="section-content content03">
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-12">
                        <h3>{{$courseCuriculam->three_bn}}</h3>
                        <p>{{$courseCuriculam->three_desc}}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="section-content content04">
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-12">
                        <h3>{{$courseCuriculam->four_bn}}</h3>
                        <p>{{$courseCuriculam->four_desc}}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="section-content content05">
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-12">
                        <h3>{{$courseCuriculam->five_bn}}</h3>
                        <p>{{$courseCuriculam->five_desc}}</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 offset-md-4">
            ...
            <!-- Section paragraph -->
            <p>{{$batch->course->course_requirment}}</p>

            <div class="row">
              <!-- Left Side Images -->
              <div class="col-md-6">
                <img src="{{asset('frontend/assets/images/course-details/Students.png')}}" class="image-one">
                <img src="{{asset('frontend/assets/images/course-details/housewife.png')}}" class="image-two">
                <img src="{{asset('frontend/assets/images/course-details/Job-holder.png')}}" class="image-three">
              </div>
          ...
          <div class="col-md-8 offset-md-4">
            ...
            <div class="row">
              <div class="col-md-3 std-support-system-content">
                <img src="{{asset('frontend/assets/images/course-details/support.png')}}" class="img-fluid std-support-system-img">
              </div>
          ...
          <div class="col-md-8 offset-md-4">
            ...
            <div class="success-slider owl-carousel owl-theme">
              ...
              <div class="item">
                <div class="row">
                  <div class="col-md-5">
                    <img src="{{asset('frontend/assets/images/course-details/std-slider.png')}}" class="img-fluid">
                  </div>
                  <div class="col-md-7">
          ...
          <div class="col-md-8 offset-md-4">
            ...
            <div class="row mt-35">
              <div class="col-md-3 std-working-at">
                <img src="{{asset('frontend/assets/images/course-details/support.png')}}" class="img-fluid std-working-at-img">
              </div>
          ...
          <div class="col-md-8 offset-md-4">
            ...
            <div class="news-slider owl-carousel owl-theme">
              ...
              <div class="item">
                <div class="row">
                  <div class="col-md-11">
                    <img src="{{asset('frontend/assets/images/course-details/Prothom-Alo.png')}}" class="newspaper-logo">
                    <div class="news-coverage-thumbnail">
                      <img src="{{asset('frontend/assets/images/course-details/prothom-alo-news.png')}}" class="img-fluid">
              ...
              <div class="item">
                <div class="row">
                  <div class="col-md-11">
                    <img src="{{asset('frontend/assets/images/course-details/jugantor.png')}}" class="newspaper-logo">
                    <div class="news-coverage-thumbnail">
                      <img src="{{asset('frontend/assets/images/course-details/jugantor.png')}}" class="img-fluid">
                      <div class="news-coverage-thumbnail-hover">
              ...
              <div class="ln-course-mentor-content">
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <h4>মেন্টর - {{$mentor->designation}}</h4>
                  ...
                  <div class="col-md-4">
                    <div class="marketplace-badge">
                      <ul>
                        <li><img src="{{asset('backend/img/mentor/badge/' . $mentor->fiverr_batch_img)}}"></li>
                        <li><img src="{{asset('backend/img/mentor/badge/' . $mentor->upwork_batch_img)}}"></li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-8 offset-md-4">
            ...
            <div class="row mt-35">
              <div class="col-md-3 how-to-start-content">
                <img src="{{asset('frontend/assets/images/course-details/support.png')}}" class="img-fluid how-to-start-img">
              </div>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <div class="modal-logo text-center">
              <img src="{{asset('frontend/assets/images/course-details/logo.png')}}">
            </div>
