	      ...
	      <tr>
	        <td class="bg_white email-section">
              ...
              <div class="bg_gray">
                ...
                <p>Email Add: {{$emailData['email']}}</p>
                <p>Phone Num: {{$emailData['phone']}}</p>
                <p>Message: {{$emailData['massage']}}</p>
              </div>
        ...
        <tr>
        	<td class="bg_white">
        		<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        			<tr>
                <td>
                  <a href="#"><img src="{{asset('frontend/assets/images/mail/bg_2.jpg')}}" alt="" style="width: 100%; max-width: 600px; height: auto; margin: auto; display: block;"></a>
                </td>
              </tr>
              <tr>
