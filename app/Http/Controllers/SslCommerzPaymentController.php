...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['cus_mentor_id'] = $request->mentor_id;

        # SHIPMENT INFORMATION
        $post_data['ship_name'] = "E learning platform";
        $post_data['ship_add1'] = "Mirpur 12 Pallabi";
        $post_data['ship_add2'] = "";
        $post_data['ship_city'] = "Dhaka";
        $post_data['ship_state'] = "";
        $post_data['ship_postcode'] = "1216";
        $post_data['ship_phone'] = "01681091191";
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $post_data['cus_city'] = $request->city;
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = $request->zipcod;
        $post_data['cus_country'] = $request->country;
        $post_data['cus_phone'] = $request->phone;
        $post_data['cus_fax'] = "";
    ...
    public function success(Request $request)
    {
        ...
        return view('frontend.pages.success', compact('user_id', 'course_id', 'batch_id'));

        $sslc = new SslCommerzNotification();

        $order_detials = DB::table('orders')
            ->where('transaction_id', $tran_id)
            ->select('transaction_id', 'status', 'currency', 'amount', 'course_id', 'batch_id', 'user_id')->first();
        ...
        if ($order_detials->status == 'Pending') {
            ...
            if ($validation == TRUE) {
                ...
                */
                ...
                return view('frontend.pages.success', compact('order_detials', 'course_id', 'batch_id','mentor_id'));
            } else {
                /*
